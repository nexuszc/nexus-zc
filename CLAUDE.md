...
**NEXT:**
1. Set `ELEVENLABS_API_KEY` in Supabase secrets (required for publisher to work)
...
- After approving scripts: `publish youtube` — process all approved scripts through publisher
